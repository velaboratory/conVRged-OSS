Shader "ENGREDUVR/TargetArea"
{
	...
	SubShader
	{
		...
		void surf (Input IN, inout SurfaceOutputStandard o)
		{
			...
			float2 uv2 = uv1;
			float2 uv3 = float2(uv1.x, uv1.y);

			uv2.x += .1*sin(50*_Time);
			uv2.y -= 10* _Time;
			fixed4 noise2 = tex2D (_MainTex, uv2);

			uv3.x += -.1*sin(50*_Time);
			uv3.y -= 20* _Time;
			uv3 /= 10;
			fixed4 noise3 = tex2D (_MainTex, uv3);
			...
			o.Albedo = c.rgb * 10 * noise2;
			o.Alpha = alphaFade * c.a * noise3;
		}
		ENDCG
	}
	FallBack "Diffuse"

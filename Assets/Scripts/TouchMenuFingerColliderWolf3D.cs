...
public class TouchMenuFingerColliderWolf3D : MonoBehaviour
{
	public bool isLeft;
	...
	private void Start()
	{
		followCollider.SetParent(GetComponentInParent<Wolf3DAvatar>().transform);
	}
	...
	public void SelectableEnter(Button i, TouchMenuFingerColliderWolf3D finger, Vector3 velocity)
	{
	...
	public void SelectableExit(Button i, TouchMenuFingerColliderWolf3D finger)
	{
